        ...
        <div class="offset-sm-3 col-sm-6" style="min-height:400px;">
          ...
          <div class="card bg-secondary text-light">
            <div class="card-header">
              ...
              <form class="" action="returnReciept.php?id=<?php echo $_GET["id"];?>" method="get">
                ...
                <p>
                    ...
                    <input type = "submit" name = "submit" class="button orange" style="height: 50px; width: 100px;" value = "SIGN UP" />
                    </form>
                </p>
                </form>
                </div>
